...
Deployed Application (**required**): [Kudos Board Deployed Site](https://kudos-board-client.onrender.com/)
...
I feel that all the topics discussed in the lab helped prepare me to complete the assignment. I followed all the labs to a tee and felt like it helped me understand the process of creating an application from start to finish.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
If I had more time, I wish I would've worked on my stretch features, as I really was swapped with this and the two other projects. I am pretty happy with the way that everything else turned out. Also, I wish that I would've been more creative with implementing pictures so that boards have different photos.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

As for my project demo, I feel that alot went well, but the problems started rolling in when I went to deploy my project using Render. While the front end deployed, the back end was not functioning due to prisma malfunctions. I wish I would've ask questions earlier when I was initially having problems instead of trying to solve it myself and potentially making a easy situation harder.
